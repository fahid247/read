...
export default function RegisterForm() {
  ...
  const searchParams = useSearchParams(); // Now properly handled by Suspense

  const [loading, setLoading] = React.useState(false);

  // You can use searchParams if needed, e.g., for redirect after registration
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <div className="w-12 h-12 bg-primary rounded-xl flex items-center justify-center mb-4 shadow-lg shadow-primary/30">
              <span className="text-[#0A0F1E] font-bold text-xl"><ReadMartLogo /></span>
            </div>
